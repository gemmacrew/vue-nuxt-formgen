...
const onUpdateForm = ({values, meta}, formName) => {
  ...
  // formsConfig.value.applicantDetails.fields.nameHistoryList.props.reveal = application.value.hasNameHistory === 'true'
  // application.value.nameHistoryList = application.value.hasNameHistory === 'true' ? application.value.nameHistoryList : []
...
.v-stepper-item {
  ...
  &--complete {
    ...
    .v-avatar {
      background-color: rgb(0, 198, 0) !important;
    }
  }
}
